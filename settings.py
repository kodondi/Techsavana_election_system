...
ALLOWED_HOSTS = get_from_env('ALLOWED_HOSTS', '127.0.0.1').split(",")



#expose your sever throuth engrok

ALLOWED_HOSTS=['127.0.0.1','locolhost','111c-197-138-6-5.ngrok.io ']
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'Techsavana  Voting system')
...
HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'info@techsavanna.technology')
...
EMAIL_HOST_USER = 'kodondikodondi@gmail.com'
EMAIL_HOST_PASSWORD = 'vcffalcjwaguqdbv' #past the key or password app here
EMAIL_PORT = 587
EMAIL_USE_TLS = True
